...
const Projects: React.FC = () => {
  const [isVisibilite, setisVisibilite] = useState(false); // fade first loading

  useEffect(() => {
    setTimeout(() => {
      setisVisibilite(true);
    }, 4800); // delay
  }, []);
          ...
          >
            ...
            >
              ...
              <div className="mainTextMobile">
                ...
                <Link
                  className={`goProject ${isVisibilite ? "faden" : ""}`}
                  to="https://dprofile.ru/case/76591/real-estate"
                  target="_blank"
                  rel="noopener noreferrer"
                >
          ...
          >
            ...
            >
              ...
              <div className="mainTextMobile">
                ...
                <Link
                  className={`goProject ${isVisibilite ? "" : ""}`}
                  to="https://dprofile.ru/case/55727/perfume-shop"
                  target="_blank"
                  rel="noopener noreferrer"
                >
